...
namespace Rap_Finands
{
    ...
    **/
    class Program
    {
        ...
        {
            var baseDir = System.IO.Directory.GetCurrentDirectory().ToString();

            //Console.WriteLine(baseDir);

            //Console.WriteLine(Environment.GetFolderPath(Environment.SpecialFolder));
        ...
        */
        ...
        public static void hent()
        {
            ...
            var baseDir = Path.GetDirectoryName(datafil);
